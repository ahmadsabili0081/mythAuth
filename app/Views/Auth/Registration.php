              ...
              <div class="p-5">
                ...
                <form action="<?= url_to('register') ?>" method="post" class="user">
                  ...
                  <div class=" form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="password" class="form-control form-control-user <?php if (session('errors.pass_confirm')) : ?>is-invalid<?php endif ?>" name="pass_confirm" id="exampleRepeatPassword" placeholder="<?= lang('Auth.repeatPassword') ?>">
                    </div>
                  </div>
                ...
                <div class="text-center">
                  <small><?= lang('Auth.alreadyRegistered') ?> <a href="<?= url_to('login') ?>"><?= lang('Auth.signIn') ?></a></small>
                </div>
              </div>
            </div>
          </div>
